class LinksBar extends HTMLElement {
    connectedCallback() {
        ...
        <div class="floor" id="floor">
            <a href="https://www.reddit.com/user/theDuckPancake" target="_blank"><button class="btn reddit">
                <picture>
            ...
            <a href="https://www.buymeacoffee.com/theDuckPancake" target="_blank"><button class="btn coffee">
                <picture>
            ...
            <a href="https://www.instagram.com/tdp_thepancakecut/" target="_blank"><button class="btn insta">
                <picture>
